...
/**
 * This is the reference implementation that the diff patch framework is based upon.  It is included 
 * here in the test section so that output from our code can be verified.
 * 
