...
public class DiffTest {
    ...
    // private void assertBufferEquals( String title, String[] expected,
    // SpanBuffer[] result)
    // {
    ...
    // {
    // assertEquals( title+" Error at item "+i, Factory.wrap(expected[i]),
    // result[i]);
    // }
    // }
    ...
    //
    // diffs = diffList(new Diff(EQUAL, "a"), new Diff(EQUAL, "b"), new Diff(EQUAL,
    // "c"));
    // dmp.diff_cleanupMerge(diffs);
    // assertEquals("diff_cleanupMerge: Merge equalities.", diffList(new Diff(EQUAL,
    // "abc")), diffs);
    //
    @Test
    ...
    // diffs = diffList(new Diff(DELETE, "a"), new Diff(DELETE, "b"), new
    // Diff(DELETE, "c"));
    // dmp.diff_cleanupMerge(diffs);
    // assertEquals("diff_cleanupMerge: Merge deletions.", diffList(new Diff(DELETE,
    // "abc")), diffs);
    //
    ...
    // diffs = diffList(new Diff(INSERT, "a"), new Diff(INSERT, "b"), new
    // Diff(INSERT, "c"));
    // dmp.diff_cleanupMerge(diffs);
    // assertEquals("diff_cleanupMerge: Merge insertions.", diffList(new
    // Diff(INSERT, "abc")), diffs);
    ...
    // diffs = diffList(new Diff(DELETE, "a"), new Diff(INSERT, "b"), new
    // Diff(DELETE, "c"), new Diff(INSERT, "d"), new Diff(EQUAL, "e"), new
    // Diff(EQUAL, "f"));
    // dmp.diff_cleanupMerge(diffs);
    // assertEquals("diff_cleanupMerge: Merge interweave.", diffList(new
    // Diff(DELETE, "ac"), new Diff(INSERT, "bd"), new Diff(EQUAL, "ef")), diffs);
    ...
    //
    // diffs = diffList(new Diff(DELETE, "a"), new Diff(INSERT, "abc"), new
    // Diff(DELETE, "dc"));
    // dmp.diff_cleanupMerge(diffs);
    // assertEquals("diff_cleanupMerge: Prefix and suffix detection.", diffList(new
    // Diff(EQUAL, "a"), new Diff(DELETE, "d"), new Diff(INSERT, "b"), new
    // Diff(EQUAL, "c")), diffs);
    @Test
    ...
    //
    // diffs = diffList(new Diff(EQUAL, "x"), new Diff(DELETE, "a"), new
    // Diff(INSERT, "abc"), new Diff(DELETE, "dc"), new Diff(EQUAL, "y"));
    // dmp.diff_cleanupMerge(diffs);
    // assertEquals("diff_cleanupMerge: Prefix and suffix detection with
    // equalities.", diffList(new Diff(EQUAL, "xa"), new Diff(DELETE, "d"), new
    // Diff(INSERT, "b"), new Diff(EQUAL, "cy")), diffs);
    ...
    // diffs = diffList(new Diff(EQUAL, "a"), new Diff(INSERT, "ba"), new
    // Diff(EQUAL, "c"));
    // dmp.diff_cleanupMerge(diffs);
    // assertEquals("diff_cleanupMerge: Slide edit left.", diffList(new Diff(INSERT,
    // "ab"), new Diff(EQUAL, "ac")), diffs);
    @Test
    ...
    // diffs = diffList(new Diff(EQUAL, "c"), new Diff(INSERT, "ab"), new
    // Diff(EQUAL, "a"));
    // dmp.diff_cleanupMerge(diffs);
    // assertEquals("diff_cleanupMerge: Slide edit right.", diffList(new Diff(EQUAL,
    // "ca"), new Diff(INSERT, "ba")), diffs);
    ...
    // diffs = diffList(new Diff(EQUAL, "a"), new Diff(DELETE, "b"), new Diff(EQUAL,
    // "c"), new Diff(DELETE, "ac"), new Diff(EQUAL, "x"));
    // dmp.diff_cleanupMerge(diffs);
    // assertEquals("diff_cleanupMerge: Slide edit left recursive.", diffList(new
    // Diff(DELETE, "abc"), new Diff(EQUAL, "acx")), diffs);
    ...
    // diffs = diffList(new Diff(EQUAL, "x"), new Diff(DELETE, "ca"), new
    // Diff(EQUAL, "c"), new Diff(DELETE, "b"), new Diff(EQUAL, "a"));
    // dmp.diff_cleanupMerge(diffs);
    // assertEquals("diff_cleanupMerge: Slide edit right recursive.", diffList(new
    // Diff(EQUAL, "xca"), new Diff(DELETE, "cba")), diffs);
