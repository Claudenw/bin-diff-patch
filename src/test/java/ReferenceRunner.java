...
public class ReferenceRunner {
    ...
    // r.Diff_Timeout = 0f;
    ////// String first = "Now is the time for all good men to come to the aid of
    // their country";
    ////// String second = "Then was the time for all good men to have come to the
    ...
    // String middle = "Knowing that the time had come for her to leave this world,
    // where she "
    ...
    //
    // String left = "This eBook is for the use of anyone anywhere in the United
    // States and most"
    ...
    // ebook.";
    //
    // String right = "'Legal Entity' shall mean the union of the acting entity and
    // all "
    ...
    //// URL url1 =
    // Thread.currentThread().getContextClassLoader().getResource("dataOld");
    ////
    //// SpanBuffer buff = SpanBuffer.Factory.wrap(url1.openStream());
    //// String buffer1 = buff.getText();
    ////
    //// URL url2 =
    // Thread.currentThread().getContextClassLoader().getResource("dataNew");
    ////
    ...
    //// di.add(new Diff(Operation.EQUAL, "men to come to the aid of their
    // country."));
    ////
    ...
    //// %0D%0Abo
    ////
    //// String txt = "Knowing that the time had come for her to leave this world,
    // where she";
    //// Patch pf = new Patch();
    //// pf.start1=516;
    //// pf.start2=516;
    ...
    //// pf.diffs.add( new Diff( Operation.DELETE, "xboot system flash
    // c2800nm-advipservicesk9-mz.124-32a.bin" ));
    ...
    public static void main(String[] args) throws Exception {
        ...
        // LinkedList<Reference.Patch> patches =
        // r.patch_make("abcdefghijklmnopqrstuvwxyz--------------------1234567890",
        // "abcXXXXXXXXXXdefghijklmnopqrstuvwxyz--------------------1234567YYYYYYYYYY890");
        // for (Reference.Patch p : patches)
        // {
        // System.out.println( p.toString() );
